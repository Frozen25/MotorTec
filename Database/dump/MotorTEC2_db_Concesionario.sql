...
CREATE TABLE `Concesionario` (
  ...
  KEY `fk_Concesionario_Ubicacion1_idx` (`Ubicacion_idUbicacion`),
  KEY `fk_Concesionario_Taller1_idx` (`Taller_idTaller`),
  CONSTRAINT `fk_Concesionario_Taller1` FOREIGN KEY (`Taller_idTaller`) REFERENCES `Taller` (`idTaller`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_Concesionario_Ubicacion1` FOREIGN KEY (`Ubicacion_idUbicacion`) REFERENCES `Ubicacion` (`idUbicacion`) ON DELETE NO ACTION ON UPDATE NO ACTION
