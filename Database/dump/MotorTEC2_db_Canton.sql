...
CREATE TABLE `Canton` (
  ...
  CONSTRAINT `fk_Canton_Provincia1` FOREIGN KEY (`Provincia_idProvincia`) REFERENCES `Provincia` (`idProvincia`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
INSERT INTO `Canton` VALUES (1,'Cartago',3),(2,'Alvarado',3);
